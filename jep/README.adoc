...
| Not Submitted{nbsp}:information_source:
| link:0000/README.adoc[JEP-219: Jenkins Kubernetes Operator]
...
| Draft{nbsp}:speech_balloon:
| link:219/README.adoc[JEP-0000: Jenkins Kubernetes Operator]
| link:https://github.com/tomaszsek[Tomasz{nbsp}Sęk] from{nbsp}link:https://virtuslab.com/[VirtusLab]
| TBD
