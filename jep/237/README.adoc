...
To facilitate testing of specific FIPS parts, a library [fips-bundle-test](https://github.com/jenkinsci/lib-fips-bundle-test) has been created to use with `jenkins-test-harness`.
