= JEP-223: New "Limited Administer" permission for managing non-security aspects of a Jenkins instance
:toc: preamble
:toclevels: 3
ifdef::env-github[]
:tip-caption: :bulb:
...
| Title
| New "Limited Administer" permission for managing non-security aspects of a Jenkins instance
