= JEP-213: Create a new "Limited Administer" permission named "Configure" for managing non-security aspects of a Jenkins instance
:toc: preamble
:toclevels: 3
ifdef::env-github[]
:tip-caption: :bulb:
...
| Title
| Create a new "Limited Administer" permission named "Configure" for managing non-security aspects of a Jenkins instance
