...
Jenkins uses Java 17 as its minimum Java version for approximately **one year**.
...
Jenkins uses Java 21 as its minimum Java version for approximately **two years**.
