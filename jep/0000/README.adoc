...
{
    "core" : {
        "uri" : "https://updates.jenkins.io/some/path/to/a/jenkins.war",
        "checksum" : {
            "type" : "sha256",
    ...
    "plugins" : {
        "updates" : [
            {
                "uri" : "https://updates.jenkins.io/some/path/to/a/plugin.hpi",
                "checksum" : {
                    "type" : "sha256",
                    "signature" : "somechecksumforthefile"
                }
            ...
            {
                "uri" : "https://updates.jenkins.io/some/path/to/another/plugin.hpi",
                "checksum" : {
                    "type" : "sha256",
                    "signature" : "somechecksumforthefile"
                }
    ...
    "client" : {
        "uri" : "https://updates.jenkins.io/some/path/to/a/evergreen-client.tar.gz",
        "checksum" : {
            "type" : "sha256",
            "signature" : "somechecksumforthefile"
        }
...
* `client` which incidates a new tarball for upgrading the `evergreen-client`
  itself.
...
Not necessary as there is no pre-existing implemntation.
