...
====
* # of executors
* Jenkins URL [TODO: it is displayed in the screenshot]
* System Admin e-mail address [TODO: it is displayed in the screenshot]
* Resource root [TODO: it is displayed in the screenshot]
* Global properties
    * Environment variables
    * Tool Locations
* Administrative monitors configuration: this doesn't allow permissions escalation by itself, but a user can change these settings to hide security warnings messages from Administer.
