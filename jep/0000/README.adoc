...
* link:https://issues.jenkins-ci.org/browse/JENKINS-13154[JENKINS-13154] _Heavy thread congestion with `FingerPrint.save`_
* link:https://issues.jenkins-ci.org/browse/JENKINS-18775[JENKINS-18775] _`ConcurrentModificationException` from `DefaultConverterLookup`_
