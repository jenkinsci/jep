...
generate an encrypted link:https://jwt.io[JSON Web Token]
which contains a **14 day expiry** for the <<claims>> contained within the
token. Reasoning for <<jwt>> can be found below.
