...
** link:https://github.com/jenkinsci/active-directory-plugin/pull/102[active-directory-plugin #102] (cleanup by jglick)
...
** link:https://github.com/jenkinsci/blueocean-plugin/pull/2084[blueocean-plugin #2084] (cleanup by jglick)
** link:https://github.com/jenkinsci/saml-plugin/pull/90[saml-plugin #90] (Spring update by kuisathaverat)
** link:https://github.com/jenkinsci/branch-api-plugin/pull/209[branch-api-plugin #209] (cleanup by jglick)
** link:https://github.com/jenkinsci/splunk-devops-plugin/pull/13[splunk-devops-plugin #13] (cleanup by jglick)
** link:https://github.com/jfrog/jenkins-artifactory-plugin/pull/327[artifactory-plugin #327] (cleanup by jglick)
* Exploratory work
