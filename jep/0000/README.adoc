...
https://github.com/jenkinsci/jenkins/pull/5890[jenkinsci/jenkins#5890] adds telemetry from Jenkins 2.322 until 2022-03-01 to identify any (expected to be rare) uses of `FilePath` methods from agents to access files on the controller.
