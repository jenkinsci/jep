= JEP-0000: Essentials Client Error Telemetry Logging
:toc: preamble
:toclevels: 3
ifdef::env-github[]
:tip-caption: :bulb:
...
NOTE: The JSON excerpts below are pretty-printed for readability.
This will most likely not be the case in real conditions.
