...
* Some classes defined in test utilities, by mocking frameworks, etc., when running inside tests.
...
in which cases plugin developers or administrators are likely to need instructions on how to proceed.
