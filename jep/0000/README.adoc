= JEP-0000: Google Summer of Code Budgeting and Expenses
:toc: preamble
:toclevels: 3
ifdef::env-github[]
:tip-caption: :bulb:
...
** TTravel grants do NOT cover expenses that are already covered event organizers, or other types of sponsors.
