Use this space to track the status of plugins that may or may not be compatible with JEP-:bulb:.
...
|Incompatible, fixes prepared
|Pending link:https://github.com/jenkinsci/promoted-builds-plugin/pull/150[promoted-builds-plugin #150].
