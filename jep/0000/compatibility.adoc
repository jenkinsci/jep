...
|Mostly compatible
|Pending link:https://github.com/jenkinsci/pipeline-maven-plugin/pull/252[pipeline-maven-plugin #252] for full compatibility.
...
|Mostly compatible
|Pending link:https://github.com/jenkinsci/plugin-util-api-plugin/pull/50[plugin-util-api-plugin #50] for full compatibility.
