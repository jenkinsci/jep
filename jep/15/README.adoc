...
Sponsorships cover the most of our "big" expenses (e.g. Azure, meetup.com, contributor summits, etc.),
and there is a tendency to formalize such donations through Continuous Delivery Foundation (CDF).
Sponsorship through CDF is a lengthy process not suitable for small donations.

It would be great to have a simple process so that we can raise money to facilitate the initiatives in the project and to cover infrastructure costs which ave no sponsorship.
...
* SSL certificates on services which have not been migrated to LetsEncrypt or similar services yet
* Domain costs
...
In no case Jenkins project will commit to deliver a feature or on a timeline.
