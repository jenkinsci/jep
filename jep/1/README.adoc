...
. **Backwards Compatibility** - All JEPs must include a section describing any incompatibilities and their severity.
  The JEP must explain how the it proposes to deal with these incompatibilities.
  If there are no backwards compatibility concerns, the section must say that.
. **Security** - All JEPs must include a section describing any security risks and their severity.
  The JEP must explain how the it proposes to deal with these risks.
  If there are no security concerns, the section must say that.
. **Infrastructure Requirements** -
  All JEPs must include a section describing any infrastructure changes or addtions they require.
  The JEP must explain the scope of these changes in reasonable detail.
  If there are no infrastructure changes, the section must say that.
