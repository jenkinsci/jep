...
* Delegate their responsibilities to other contributors as neeeded on a per-JEP basis (see <<BDLF Delegate>>)
...
A BDFL Delegate may not delegate to someone else -
there is no such thing as a "BDFL Delegate Delegate".
The BDFL may remove a Delegate or a BDFL Delegate may resign from from a JEP at any time.
When a Delegate leaves or is removed from a JEP,
the BDLF becomes the reviewer again and may ask someone else to be the BDLF Delegate for that JEP.
...
For disputes over JEP proecess or decisions made by a <<BDFL Delegate>>,
contributors may request that the <<BDFL>> intervene.
The BDFL will consider the matter, and render their decision,
including describing what actions will be taken and documenting their reasoning.
The BDLF's decision may include technical and other specific instructions to the BDLF Delegate.
