...
You must also scroll back into the `deploy` log to even find the selected timestamp
so that it can be copied and pasted into the downstream POM.
...
* link:https://www.slideshare.net/jgcloudbees/continual-delivery-with-maven-microrepos[Continual Delivery with Maven Microrepos] (slides from talk on 2019-10-14)
