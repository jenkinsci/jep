...
For Evergreen/Evergreen, some “bill of materials” to be determined will determine exact versions of components.
For plugins, the
...
with Evergreen/Evergreen exercising the concepts initially.
