...
That would contradict one of the goals of link:https://github.com/jenkinsci/jep/tree/master/jep/300[Evergreen], that you can get a reasonable workflow going in a few minutes.
...
(AWS-specific installers for Jenkins, such as for Evergreen, could preconfigure these fields.)
