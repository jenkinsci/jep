...
** Accepted - patch in the plugin. to be done by _JEP-200 maintainer(s)_
** Accepted - update whitelist in the core (similar to link:https://github.com/jenkinsci/jenkins/pull/3120/files#diff-ff24cb984ddd641f49a22cc13a90cfd3[these cases]), to be done _JEP-200 maintainer(s)_
