...
* A custom `ClassFilter` implementation may override any behavior. This is discussed in the compatibility section.
...
If everything goes fine, the Remoting release may be integrated into the weekly release
(without actual use of the new API).
