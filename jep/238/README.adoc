...
The majority of issues render fine, the ones that mostly fail are when there's HTML in the Jira issue description, e.g. wrapped around a `noformat` or code block.
