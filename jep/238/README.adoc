...
=== How do I find issues I've reported on Jira?

In the GitHub issues search bar add `reported by: <your-jira-username>`.

E.g. https://github.com/timja-org/jenkins-gh-issues-poc-11-06/issues?q=is%3Aissue%20%20reported%20by%3A%20kohsuke
