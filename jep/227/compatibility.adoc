...
is necessary. Also link:https://github.com/jenkinsci/github-oauth-plugin/pull/122[github-oauth-plugin #122] for a small bug.
Given that, it seems to work.

|link:https://plugins.jenkins.io/gitlab-oauth/[gitlab-oauth]
|Mostly compatible
|SecurityRealm tested, Authorization strategy tested without "Use Gitlab repository permissions". link:https://github.com/jenkinsci/gitlab-oauth-plugin/pull/27[gitlab-oauth-plugin #27] for a small bug.
